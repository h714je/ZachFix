...
- runtime-log entry to states `09`, `0A`, and `0B` before enabling any production patch;
- validate the recovered strafe gate at GOG `00504567` / Steam `00504497`, including capability `0x2000`, `Player+0x638 & 0x10`, mutually held shoulders, edge semantics, and early-return parity with Xbox;
- decide production binding policy: original LB/RB semantics for Xbox360 profile versus explicit remappable Strafe Left/Right actions. Do not reinterpret Xbox logical `0x100/0x200` as PC action masks;
- validate Quick Turn normal and combat branches on keyboard and controller, including the proposed Run binding substitution and removal of the Director's Cut HoldBreath prerequisite;
- test camera/collision and 30/60/high-FPS behavior during strafe and 180-degree turn before promotion.
